...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch_files/chatbot_only'), glob('launch_files/chatbot_only/*.py')),
        (os.path.join('share', package_name, 'launch_files/full_system'), glob('launch_files/full_system/*.py')),
        (os.path.join('share', package_name, 'launch_files/patrol_only'), glob('launch_files/patrol_only/*.py')),
