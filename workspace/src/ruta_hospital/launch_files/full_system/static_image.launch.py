...
def generate_launch_description():
    ...
    fotos_cmd = TimerAction(
        ...
        actions=[
            Node(
                ...
                executable='fotos',
                name='photos_node',
                parameters=[{'use_sim_time': True, 'capture_mode': 'image'}],
                output='screen',
                prefix='gnome-terminal -- ' 
            )
        ]
    ...
    # Orquestador SOTA (Patrón Strategy) -> Nodo Híbrido en modo imagen
    ...
    llm_reporter_cmd = TimerAction(
        ...
        actions=[
            Node(
                ...
                parameters=[{'use_sim_time': True, 'perception_mode': 'image'}],
                output='screen',
                prefix='gnome-terminal -- '
            )
        ]
